...
namespace Hosting.Controllers
{
	public class AppsController : ApiController
	{
		...
		public Voodoo.Messages.Response Put
			...
			{
				var op = new Hosting.Operations.Apps.AppAddCommand(request);
		...
		public Voodoo.Messages.Response Post
			([FromUri] Hosting.Operations.Apps.AppMessage request)
			{
				var op = new Hosting.Operations.Apps.AppUpdateCommand(request);
				var response = op.Execute();
				return response;
			}
		...
		[HttpGet]
		public Voodoo.Messages.PagedResponse<Hosting.Operations.Apps.AppMessage> Get
			([FromUri] Hosting.Operations.Apps.AppQueryRequest request)
			{
				var op = new Hosting.Operations.Apps.AppQuery(request);
				var response = op.Execute();
				return response;
			}
